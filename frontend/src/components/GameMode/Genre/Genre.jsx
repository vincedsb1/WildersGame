...
function Genre({ setRequest, request }) {
  ...
  return (
    <div className="genre">
      <button
        type="button"
        id="genre"
        onClick={() => handleGenre(filterGenre1)}
      >
        None 🍄
      </button>
      <br />
      <button
        type="button"
        id="genre"
        onClick={() => handleGenre(filterGenre2)}
      >
        French 🥐
      </button>
      <br />
      <button
        type="button"
        id="genre"
        onClick={() => handleGenre(filterGenre3)}
      >
        Action 🔥
      </button>
      <br />
      <button
        type="button"
        id="genre"
        onClick={() => handleGenre(filterGenre4)}
      >
        Thriller 👮
      </button>
      <br />
      <button
        type="button"
        id="genre"
        onClick={() => handleGenre(filterGenre5)}
      >
        Comedy 😊
      </button>
      <br />
      <button
        type="button"
        id="genre"
        onClick={() => handleGenre(filterGenre6)}
      >
        Science Fiction 🧟
      </button>
    </div>
